...
export async function stepInstallPAI(
	...
	const envContent = `# PAI-OpenCode Environment Variables
# Generated by installer - DO NOT COMMIT THIS FILE
${state.collected.provider?.toUpperCase() || "ZEN"}_API_KEY=${state.collected.apiKey || ""}
${state.collected.voiceProvider?.toUpperCase() || "ELEVENLABS"}_API_KEY=${state.collected.elevenLabsKey || ""}
`;
