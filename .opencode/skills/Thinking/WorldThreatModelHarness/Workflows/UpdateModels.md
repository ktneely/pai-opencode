...
- Model template at `~/.opencode/skills/WorldThreatModelHarness/ModelTemplate.md`
...
```
Read ~/.opencode/MEMORY/RESEARCH/WorldModels/INDEX.md (if exists)
...
Save to: `~/.opencode/MEMORY/RESEARCH/WorldModels/{horizon}.md`

### Step 5: Update INDEX

Write/update `~/.opencode/MEMORY/RESEARCH/WorldModels/INDEX.md`:
