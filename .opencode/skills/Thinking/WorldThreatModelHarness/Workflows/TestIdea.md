...
- World models must exist at `~/.opencode/MEMORY/RESEARCH/WorldModels/`
...
```
Check ~/.opencode/MEMORY/RESEARCH/WorldModels/ for all 11 model files.
...
Read all 11 model files from `~/.opencode/MEMORY/RESEARCH/WorldModels/`.
