...
created: 2025-12-17
extracted_from: SKILL.md (context loading section)
---
...
**All documentation files are in `~/.opencode/PAI/` with USER/ subdirectory for personal overrides. Read these files when you need deeper context.**
...
See `SKILLSYSTEM.md` for complete documentation.
...
- `PAISECURITYSYSTEM/` - Security architecture, patterns, and defense protocols | Triggers: "security system", "security patterns", "prompt injection"
- `PAI/USER/PAISECURITYSYSTEM/` - Personal security policies (private) | See security section below for critical always-active rules
