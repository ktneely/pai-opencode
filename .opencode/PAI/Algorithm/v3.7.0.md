...
**Note:** This table lists Claude Code built-in capabilities. For OpenCode-specific differences (e.g., Agent Teams not available, use Task tool instead), see `docs/PLATFORM-DIFFERENCES.md`.
